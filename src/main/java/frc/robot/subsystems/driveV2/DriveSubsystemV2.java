...
public class DriveSubsystemV2 extends SubsystemBase {
    ...
    private double setpoint = 0.0; // degrees
	private double simulatedVoltage = 0.0;

	public DriveSubsystemV2(NeoMotor motor) {
	...
	public void setDegreeSetpoint(double degrees){
		setpoint = degrees;
	}
  ...
  public void periodic() {
	...
	SmartDashboard.putNumber("Drive/SetpointDegrees", setpoint);
